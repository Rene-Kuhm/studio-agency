...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: post.coverImage || `/api/og?title=${encodeURIComponent(post.title)}&description=${encodeURIComponent(post.description)}&type=blog`,
          width: 1200,
          height: 630,
          alt: post.title,
        },
    ...
    twitter: {
      ...
      title: post.title,
      description: post.description,
      images: [post.coverImage || `/api/og?title=${encodeURIComponent(post.title)}&description=${encodeURIComponent(post.description)}&type=blog`],
    },
  };
}
