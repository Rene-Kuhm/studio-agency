...
// Mock posts data (in real app, this would come from getAllPosts)
const posts = [
  {
    slug: 'optimizacion-rendimiento-web',
    title: 'Optimización de rendimiento web en 2025',
    description: 'Estrategias avanzadas para mejorar la velocidad y el rendimiento de tu sitio web.',
    date: '2024-01-15',
    category: 'Desarrollo',
    tags: ['Performance', 'Web Vitals', 'Next.js'],
    readingTime: '8 min',
    color: '#a67c52',
  },
  {
    slug: 'animaciones-web-gsap-framer',
    title: 'Animaciones web con GSAP y Framer Motion',
    description: 'Guía completa para crear animaciones fluidas y atractivas en tus proyectos.',
    date: '2024-01-10',
    category: 'Desarrollo',
    tags: ['GSAP', 'Framer Motion', 'Animación'],
    readingTime: '12 min',
    color: '#c9a87c',
  },
  {
    slug: 'importancia-branding-digital',
    title: 'La importancia del branding digital',
    description: 'Cómo una identidad de marca sólida puede transformar tu presencia online.',
    date: '2024-01-05',
    category: 'Branding',
    tags: ['Branding', 'Identidad', 'Estrategia'],
    readingTime: '6 min',
    color: '#8b7355',
  },
  {
    ...
    description: 'Las tendencias visuales y de UX que dominarán el diseño web este año.',
    date: '2024-01-01',
    category: 'Diseño',
    tags: ['Tendencias', 'UI/UX', 'Diseño Web'],
    readingTime: '10 min',
    color: '#d4a574',
  },
  {
    slug: 'accesibilidad-web-guia',
    title: 'Guía de accesibilidad web',
    description: 'Cómo hacer que tu sitio web sea accesible para todos los usuarios.',
    date: '2023-12-20',
    category: 'Desarrollo',
    tags: ['Accesibilidad', 'A11y', 'Inclusión'],
    readingTime: '9 min',
    color: '#b8956c',
  },
];

const categories = ['Todos', 'Diseño', 'Desarrollo', 'Branding', 'Estrategia'];
